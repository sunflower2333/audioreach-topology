...
dnl AR_MODULE_WRSH(index, sgidx, container-idx, iid, maxip-ports, max-op-ports, in-ports, outports, src-mod, src-port, dst-mod, dst-port)
...
`                AUDIOREACH_TKN_U32_MODULE_ID STR(MODULE_ID_WR_SHARED_MEM_EP)'
