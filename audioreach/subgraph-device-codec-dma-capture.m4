...
AR_MODULE_CODEC_DMA_TX(DEVICE_INDEX, SG_INDEX, CONTAINER_INDEX, CDC_DMA_MODULE_IID, 0, 1, 0, 2, 0, 2, DEVICE_INTF_TYPE, DEVICE_INTF_INDEX, DEVICE_DATA_FORMAT) 
AR_MODULE_PCMENC(DEVICE_INDEX, SG_INDEX,       CONTAINER_INDEX, PCMENC_MODULE_IID,  1, 1, 2, 1, 1, 2, PCM_INTERLEAVED)
AR_MODULE_PCMCNV(DEVICE_INDEX, SG_INDEX,       CONTAINER_INDEX, PCMCNV_MODULE_IID,  1, 1, 2, 1, 1, 2, PCM_DEINTERLEAVED_UNPACKED)
