...
AR_MODULE_DISPLAY_PORT_SINK(MOD_INDEX, SG_INDEX, CONTAINER_INDEX, DISPLAY_PORT_SINK_MODULE_IID, 1, 0, 2, 0, 1, 0, DEVICE_INTF_TYPE, DEVICE_INTF_INDEX, `DEVICE_NAME', NONE_IID) 
