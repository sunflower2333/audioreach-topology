...
AR_MODULE_LOG(MOD_INDEX, SG_INDEX, CONTAINER_INDEX, 		LOG_MODULE_IID,     1, 1, 1, 2, 0x000019ab, 1, 0, DISPLAY_PORT_SINK_MODULE_IID)
AR_MODULE_DISPLAY_PORT_SINK(MOD_INDEX, SG_INDEX, CONTAINER_INDEX, DISPLAY_PORT_SINK_MODULE_IID, 1, 0, 1, 0, DEVICE_INTF_TYPE, DEVICE_INTF_INDEX, DEVICE_DATA_FORMAT, `DEVICE_NAME', NONE_IID) 
