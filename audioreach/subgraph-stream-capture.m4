...
AR_SUBGRAPH(SG_INDEX, PCM_DAI_ID, SG_IID_START, PCM_PERF_MODE, PCM_DIRECTION, CONT_SENARIO_ID, NUM_CONTAINERS)

AR_CONTAINER(CONTAINER_INDEX, CONT_IID_START,  CONT_CAP, CONT_STACK_SIZE, CONT_POSITION, PCM_DOMAIN_ID, NUM_MODULES)
...
AR_MODULE_LOG(PCM_INDEX,    SG_INDEX, CONTAINER_INDEX, LOG_MODULE_IID,    1, 1, 2, 1, 0                , 1, PCMCNV_MODULE_IID, 2, 0x000019af, 1, 0)
AR_MODULE_PCMCNV(PCM_INDEX, SG_INDEX, CONTAINER_INDEX, PCMCNV_MODULE_IID, 1, 1, 2, 1, LOG_MODULE_IID   , 1, PCMENC_MODULE_IID, 2, PCM_INTERLEAVED)
AR_MODULE_PCMENC(PCM_INDEX, SG_INDEX, CONTAINER_INDEX, PCMENC_MODULE_IID, 1, 1, 2, 1, PCMCNV_MODULE_IID, 1, RDSH_MODULE_IID  , 2, PCM_INTERLEAVED)
AR_MODULE_RDSH(PCM_INDEX,   SG_INDEX, CONTAINER_INDEX, RDSH_MODULE_IID,   1, 0, 2, 0, PCMENC_MODULE_IID, 1, 0, 0)
