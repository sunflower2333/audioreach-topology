...
AR_SUBGRAPH(PCM_INDEX, PCM_DAI_ID, SG_IID_START, PCM_PERF_MODE, PCM_DIRECTION, CONT_SENARIO_ID)

AR_CONTAINER(PCM_INDEX, CONT_IID_START,  APM_CONTAINER_CAP_ID_CD, 8192, APM_CONT_GRAPH_POS_STREAM, APM_PROC_DOMAIN_ID_ADSP)

AR_MODULE_WRSH(PCM_INDEX, PCM_INDEX, PCM_INDEX, WRSH_MODULE_IID,  0, 1, 0, 0, 0, 2)
AR_MODULE_PCMDEC(PCM_INDEX, 1, 1, 	       PCMDEC_MODULE_IID, 1, 1, 2, 1, 1, 2, PCM_INTERLEAVED)
AR_MODULE_PCMCNV(PCM_INDEX, 1, 1, 	       PCMCNV_MODULE_IID, 1, 1, 2, 1, 1, 2, PCM_DEINTERLEAVED_UNPACKED)
AR_MODULE_VOL_CTRL(PCM_INDEX, 1, 1, 	       VOLCTRL_MODULE_IID,1, 1, 2, 1, 1, 2)
AR_MODULE_LOG(PCM_INDEX,    1, 1, 	       LOG_MODULE_IID,    1, 1, 2, 1, 1, 2, 0x000019af, 1, 0)
