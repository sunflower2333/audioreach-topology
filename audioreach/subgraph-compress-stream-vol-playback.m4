...
AR_MODULE_WRSH(MOD_INDEX, SG_INDEX, CONTAINER_INDEX,	WRSH_MODULE_IID,  0, 1, 1, 2, PCM_DAI_ID, PHDEC_MODULE_IID)
AR_MODULE_PLACEHOLDER_DECODER(MOD_INDEX, SG_INDEX, CONTAINER_INDEX,	PHDEC_MODULE_IID, 1, 1, 1, 2, PCM_INTERLEAVED,PCMCNV_MODULE_IID)
...
AR_MODULE_VOL_CTRL(PCM_DAI_ID, SG_INDEX, CONTAINER_INDEX, VOLCTRL_MODULE_IID,1, 1, 1, 2,LOG_MODULE_IID)
