...
dnl AR_MODULE_PCMENC(index, sgidx, container-idx, iid, maxip-ports, max-op-ports, in-ports, outports, src-mod, src-port, dst-mod, dst-port,
dnl interleav)
...
`                AUDIOREACH_TKN_U32_MODULE_ID STR(MODULE_ID_PCM_ENC)'
