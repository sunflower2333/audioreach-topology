...
AR_MODULE_LOG(DEVICE_INDEX, SG_INDEX, CONTAINER_INDEX, LOG_MODULE_IID, 1, 1, 2, 1, 0         ,1, CDC_DMA_MODULE_IID, 2, 0x000019ab, 1, 0)
AR_MODULE_CODEC_DMA_RX(DEVICE_INDEX, SG_INDEX, CONTAINER_INDEX, CDC_DMA_MODULE_IID, 1, 0, 2, 0, LOG_MODULE_IID, 1, 0, 0, DEVICE_INTF_TYPE, DEVICE_INTF_INDEX, DEVICE_DATA_FORMAT) 
